...
def signal_details(decision, score, entry_low, entry_high, sl, t1, t2):
    if decision == "BUY":
        strength = "STRONG BUY" if score >= 75 else "MODERATE BUY"
        trigger = f"BUY confirmation: NIFTY closes above {entry_high:,.0f}"
        risk = sl - entry_low
        reward_t1 = t1 - entry_high
        reward_t2 = t2 - entry_high
        ...
        risk = sl - entry_high
        reward_t1 = entry_low - t1
        reward_t2 = entry_low - t2
